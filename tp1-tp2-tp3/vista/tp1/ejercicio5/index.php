...
<form action="action.php" method="post" id="form5" name="form5" class="needs-validation" novalidate>
    ...
    <div>
        <fieldset>
            ...
            <input type="radio" id="primario" name="educacion" value="Estudios Primarios" required/>
            <label for="primario">Educacion Primaria</label>

            <input type="radio" id="secundario" name="educacion" value="Estudios Secundarios" required/>
